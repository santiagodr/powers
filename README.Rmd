...
The boxcox function only takes positive values, a next extension of this function would be to perform transformation of negative values, by adding another term to the function.
Use the internal `pow` function as the machinery for the front-end functions such as `square`, `cube`.
This package was created as part of a homework for STAT547-UBC
It is an extension of the package powers created by Vincenzo Coia
It is not intended to be a serious package,
